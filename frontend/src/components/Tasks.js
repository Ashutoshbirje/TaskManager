    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg m-5">
            ...
            <form onSubmit={editingTask ? handleUpdateTask : handleAddTask} className="mb-6 bg-gray-100 p-4 rounded-lg shadow-sm">
                ...
                <button
                    type="submit"
                    className="w-full bg-orange-600 text-white py-2 rounded-md hover:bg-orange-500 transition duration-200"
                >
                                ...
                                <li key={task.id} className="flex justify-between items-center bg-gray-50 p-4 rounded-lg shadow-md transition-transform transform hover:scale-105">
                                    ...
                                    <div className="flex space-x-2 ml-4">
                                        ...
                                        <button
                                            ...
                                            className="bg-orange-600 text-white py-1 px-3 rounded hover:bg-orange-500 transition duration-200"
                                        >
                                            Edit
                                        </button>
                                        <button
